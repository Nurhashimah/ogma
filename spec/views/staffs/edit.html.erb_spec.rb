...
RSpec.describe "staff/staffs/edit", :type => :view do
  before(:each) do
    @college=FactoryGirl.create(:college)
    @grade=FactoryGirl.create(:employgrade)
    @staff=FactoryGirl.create(:basic_staff_with_position, college: @college, staffgrade: @grade)
    @info=@staff
  ...
  it "renders the edit staff form" do
    ...
    assert_select "form[action=?][method=?]", staff_info_path(@info), "post" do
