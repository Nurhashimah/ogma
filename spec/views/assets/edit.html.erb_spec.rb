...
RSpec.describe "asset/assets/edit", :type => :view do
  before(:each) do
    ...
    @asset=FactoryGirl.create(:fixed_asset, typename: "My Type A", name: "My Name A", modelname: "My Model A", serialno: "ABC1289", bookable: true, is_maintainable: true, assignedto: @staff)
