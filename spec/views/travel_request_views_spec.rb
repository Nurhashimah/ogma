...
# 
#   before { @travel_request = FactoryGirl.create(:travel_request, is_submitted: true, destination: 'some destination', depart_at: DateTime.now-2.days, return_at: DateTime.now-1.days , hod_accept: true, hod_accept_on: Date.today-3.days, applicant: @staff, replacement: @replacement, headofdept: @hod) }
# 
#   subject { page }
# 
