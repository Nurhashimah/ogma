...
#     @basic_staff_with_rank2=FactoryGirl.create(:basic_staff_with_rank)
    ...
    sign_in(@admin_user)
    @instructor_appraisal = FactoryGirl.create(:instructor_appraisal, staff_id: @admin_user.userable_id)
    
#     @instructor_appraisal = assign(:instructor_appraisal, InstructorAppraisal.create!(
#       :staff_id => @admin_user.userable_id,
#       :qc_sent => false,
...
#     ))
  ...
  it "renders the edit instructor_appraisal form" do
    ...
    assert_select "form[action=?][method=?]", staff_instructor_appraisal_path(@instructor_appraisal), "post" do
